...
export const createPayment = (document, payMoney) => {
  ...
  return {
    ...
    Amount: document.doc_gross_amount, // [required] [Amount is the number after rounding]
    ActualAmount: payMoney, // [required] [it is the real amount client give]
    Change: (payMoney - document.doc_gross_amount).toFixed(1) * 1, // [required] [ActualAmount - Amount]
