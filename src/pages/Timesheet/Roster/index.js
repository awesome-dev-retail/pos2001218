...
import "./index.scss";
import { Row, Col, Button, Icon, Modal, Input, Select, Empty, TimePicker, Popconfirm } from "antd";
...
const Roster = (props) => {
  ...
  // const { fetchRosterList, fetchTimesheetStaffs, timesheetStaffs, fetchPaidTypeList, paidTypeList, saveRoster, rosterList, delRoster, simpleDuplicateRoster, generalDuplicateRoster } = timesheetStore;
  ...
  //   return await fetchRosterList(from, to);
  // };
  //
  ...
  //   e.stopPropagation();
  //   console.log(_.cloneDeep(roster));
  //   await delRoster(roster.id);
  ...
  //   await simpleDuplicateRoster(false);
  // };
  //
  ...
  //   await generalDuplicateRoster(data, reFetchRosterList);
  // };
  //
  // const today = moment();
  ...
  return (
      <div className="timesheet-roster-page-container">
        {/*<div className="head-row"><button onClick={handleDevBtnClick}>Dev</button></div>*/}
        {/*<Row>*/}
        ...
        {/*          icon={<Icon type="copy" style={{ color: "#4a6282" }} />}*/}
        {/*          onConfirm={handleSimpleDuplicate}*/}
        {/*          okText="Yes"*/}
        {/*          cancelText="No"*/}
        {/*          placement="bottom"*/}
        {/*      >*/}
        {/*        <Button className="secondary-button duplicate-btn"><Icon type="copy" />Duplicate</Button>*/}
        {/*      </Popconfirm>*/}
        {/*    </div>*/}
        {/*  </Col>*/}
        ...
        {/*                  <Icon type="copy" onClick={handleDuplicateClick}/>*/}
        {/*                </a>*/}
        {/*              }*/}
        {/*            </h3>*/}
        ...
        {/*                            {*/}
        {/*                              !selectedWeekIsPasted &&*/}
        {/*                              <Icon onClick={() => handleAddIconClick(item)} type="plus-circle" className="new-btn pull-right"/>*/}
        {/*                            }*/}
        {/*                          </h3>*/}
        ...
        {/*                                                cancelText="No"*/}
        {/*                                            >*/}
        {/*                                              <Icon className="del-icon" type="close-circle" onClick={e => e.stopPropagation()} />*/}
        {/*                                            </Popconfirm>*/}
        {/*                                          }*/}
        {/*                                          <p>*/}
        ...
        {/*                                            <p>*/}
        {/*                                              <span>Pay rate:</span>*/}
        {/*                                              <span>{currentPaidType.paid_code} <Icon type="close" />{currentPaidType.multiple_confident}</span>*/}
        {/*                                            </p>*/}
        {/*                                          }*/}
